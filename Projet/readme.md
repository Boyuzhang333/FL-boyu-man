...
## [_Optionnel_] Concours attaque "maison" 

En absence de garanties théoriques, une partie importante de la recherche en cybersécurité consiste à réflechir aux attaques potentielles, ou _red teaming_. Votre rôle dans ce défi facultatif est de développer une attaque vous-mêmes au niveau du client malveillant. 

Rappel : 
- implémenter l'attaque dans le cas de l'argument '--attack_type my_attack'
- il n'y a qu'un seul client malveillant dans ce scénario.

<u>Pour 1 point bonus</u>: le binôme qui aura l'attaque la plus performante (convergence la plus longue de l'entraînement sur 20 rounds). Attention ! Si l'entrainement ne converge pas, l'attaque est supposée détectée. 


<u>Pour 0,5 points bonus</u>: l'attaque la plus créative. 

N'hésitez pas à donner un nom à votre attaque ! 
